#include "../Interfaces/MazeFileHandler.hpp"

// Loads the maze from a file
bool MazeFileHandler::loadMazeFromFile(const std::string& filename, Maze& maze) 
{
...
void MazeFileHandler::saveSolutionToFile(const Maze& maze) 
{
